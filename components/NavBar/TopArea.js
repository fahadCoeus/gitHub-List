        ...
        >
          ...
          <View style={{ flexDirection: "row", marginTop: 25 }}>
            <View style={{ marginRight: 25 }}>
              <TouchableOpacity
                onPress={() =>
                  this.setState({ heartselected: !this.state.heartselected })
                }
              >
                <Octicons
                  color={this.state.heartselected ? "white" : "red"}
                  name="heart"
                  size={25}
                />
              </TouchableOpacity>
            ...
            <TouchableOpacity
              onPress={() =>
                this.setState({ appSelected: !this.state.appSelected })
              }
            >
              <AntDesign
                color={this.state.appSelected ? "white" : "orange"}
                name="appstore1"
                size={25}
              />
            </TouchableOpacity>
